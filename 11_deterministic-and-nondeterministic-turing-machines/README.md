...
The certificate is a truth assignment to the variables of $\varphi$. If $\varphi$ has variables $x_1,\ldots,x_n$, the certificate can be a $\text{length}-n$ string of truth values.
